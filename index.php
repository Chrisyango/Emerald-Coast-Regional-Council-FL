...
<head>
	...
	<title>Emerald Coast Regional Council, FL</title>
		...
		<div id="top-nav" class="clearfix">
			...
			<div id="right-nav">
				...
				<ul class="translation-links hidden-sm hidden-xs">
					<li><span tabindex="0" aria-label="translate website"><img src="./_assets_/images/globe.png" alt="Globe">Translate</span>
						<ul class="clearfix">
			...
			<div id="news-links">
				<div class="news-link" style="background: url('./_assets_/images/news1.jpg') center no-repeat; background-size: cover;">
					<div class="news-content">
						...
						<p>auctor fringilla. cras justo odia, dapibus ac facilisis in, egestas eget.</p>
						<a href="./">read more</a>
					</div><!-- /.news-content -->
				</div><!-- /.news-link -->
